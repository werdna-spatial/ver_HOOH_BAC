...
def main():
    ...
    for PD_NC in PD_NC_list:
        ...
        #
        x=ds_tracers['Msum_sa_comm'].values.ravel()
        #print('HOOH :: '+str(x.size)+' '+str(np.nanmax(x))+' '+str(np.nanmin(x)), flush=True, file = sys.stdout)
        print('community :: '+str(x.size)+' '+str(np.nanmax(x))+' '+str(np.nanmin(x))+' '+str(np.nanpercentile(x,90))+' '+str(np.nanpercentile(x,50))+' '+str(np.nanpercentile(x,10)), flush=True, file = sys.stdout)
        #
        #
        fig, axs = plt.subplots(nrows=1,ncols=2,subplot_kw={'projection': ccrs.EckertIV()} , figsize=(18,10) )
        plt.subplots_adjust(wspace=0.01,hspace=0.01)
        #
        if i==0:
            HOOH_min=0.0
            ...
            PRO_min=0.0
            PRO_max=32.0e-6
            filename=str(PD_tag)+str('_map_HOOH_ratio_N_A_DepLayer_')+str(dep_layer)+str('.png')
            axs[0].annotate('N_A',
            ...
            PRO_min=0.0
            PRO_max=32.0e-6
            filename=str(PD_tag)+str('_map_HOOH_ratio_K_A_DepLayer_')+str(dep_layer)+str('.png')
            axs[0].annotate('K_A',
                    xy=(-0.15, .5), xycoords='axes fraction',
                    horizontalalignment='center', verticalalignment='center',
                    rotation=90,
            ...
            PRO_min=0.0
            PRO_max=32.0e-6
            filename=str(PD_tag)+str('_map_HOOH_ratio_S_AB_DepLayer_')+str(dep_layer)+str('.png')
            axs[0].annotate('S_AB',
                    xy=(-0.15, .5), xycoords='axes fraction',
                    horizontalalignment='center', verticalalignment='center',
                    rotation=90,
            ...
            PRO_min=0.0
            PRO_max=32.0e-6
            filename=str(PD_tag)+str('_map_HOOH_ratio_S_AS_DepLayer_')+str(dep_layer)+str('.png')
            axs[0].annotate('S_AS',
                    xy=(-0.15, .5), xycoords='axes fraction',
                    horizontalalignment='center', verticalalignment='center',
                    rotation=90,
            ...
            PRO_min=0.0
            PRO_max=32.0e-6
            filename=str(PD_tag)+str('_map_HOOH_ratio_S_ABS_DepLayer_')+str(dep_layer)+str('.png')
        ...
        cmap_comm=plt.get_cmap( 'PiYG_r')
        im_b=ds_tracers['Msum_sa_comm'].plot.pcolormesh( x='X', y='Y',
                                                   ax=axs[1],
                                                   transform=ccrs.PlateCarree(),
                                                   vmin= 0,
                                                   vmax= 1,
    ...
    #    
        ...
        axs[0].annotate('Hydrogen Peroxide',
                ...
                horizontalalignment='center', verticalalignment='center',
                color='k',fontsize=20)
        axs[1].annotate('Synechococcus/(Prochlorococcus+Synechococcus))',
                xy=(0.5, 1.15), xycoords='axes fraction',
                horizontalalignment='center', verticalalignment='center',
                color='k',fontsize=20)
        
        # if i==0:
        #     filename=str(PD_tag)+str('_map_HOOH_ratio_N_A')+str('.png')
        #     axs[0].annotate('N_A',
        #             xy=(-0.15, .5), xycoords='axes fraction',
        #             horizontalalignment='center', verticalalignment='center',
        #             rotation=90,
        #             color='k',fontsize=20)
        # elif i==1:
        #     filename=str(PD_tag)+str('_map_HOOH_ratio_K_A')+str('.png')
        #     axs[0].annotate('K_A',
        #             xy=(-0.15, .5), xycoords='axes fraction',
        #             horizontalalignment='center', verticalalignment='center',
        #             rotation=90,
        #             color='k',fontsize=20)
        # elif i==2:
        #     filename=str(PD_tag)+str('_map_HOOH_ratio_S_AB')+str('.png')
        #     axs[0].annotate('S_AB',
        #             xy=(-0.15, .5), xycoords='axes fraction',
        #             horizontalalignment='center', verticalalignment='center',
        #             rotation=90,
        #             color='k',fontsize=20)
        # elif i==3:
        #     filename=str(PD_tag)+str('_map_HOOH_ratio_S_AS')+str('.png')
        #     axs[0].annotate('S_AS',
        #             xy=(-0.15, .5), xycoords='axes fraction',
        #             horizontalalignment='center', verticalalignment='center',
        #             rotation=90,
        #             color='k',fontsize=20)
        # elif i==4:
        #     filename=str(PD_tag)+str('_map_HOOH_ratio_S_ABS')+str('.png')
        #     axs[0].annotate('S_ABS',
        #             xy=(-0.15, .5), xycoords='axes fraction',
        #             horizontalalignment='center', verticalalignment='center',
        #             rotation=90,
