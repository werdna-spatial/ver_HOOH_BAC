...
def main():
    ...
    for PD_NC in PD_NC_list:
        ...
        ds_tracers['Msum_sa_comm'] =ds_tracers['Msum_sa_pro']/(ds_tracers['Msum_sa_syn']+ds_tracers['Msum_sa_pro'])
        #
    ...
    #    
        ...
        if i==0:
            filename=str(PD_tag)+str('_map_NIMP_HOOH_ratio')+str('.png')
            ...
            filename=str(PD_tag)+str('_map_KPRO_HOOH_ratio')+str('.png')
            ...
            filename=str(PD_tag)+str('_map_SPRO_HOOH_ratio')+str('.png')
