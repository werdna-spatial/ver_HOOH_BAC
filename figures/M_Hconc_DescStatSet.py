...
def main():
    ...
    PD_tag=figcom.tag
    dep_layer=2
    filename=str(PD_tag)+str('_m')+str('_Hconc_DescStatSet_DepLayer_'+str(dep_layer)+'.png')
    ...
    #
    plt.suptitle('HOOH Concentration (mol/m^3) at Depth layer '+str(dep_layer))
    #
    ...
    #
        ...
        cbar_a.set_label('Yr '+str(name_str)+' HOOH Dep Int concentration  (mol HOOH/m^3)')
    #
