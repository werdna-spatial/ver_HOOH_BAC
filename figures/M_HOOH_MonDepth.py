...
def main():
    ...
    PD_out=figcom.out
    PD_tag=figcom.tag
    filename=str(PD_tag)+str('map')+str('_MonDep.png')
    ...
    for qtr in range(4):
        print(qtr)
        if (qtr==0):
            ds_qtr=ds_tracers.sel(T=slice("2008-02-01", "2009-02-30"))
            title=str("Feb")
        elif (qtr==1):
            ds_qtr=ds_tracers.sel(T=slice("2008-05-01", "2009-05-30"))
            title=str("May")    
        elif (qtr==2):
            ds_qtr=ds_tracers.sel(T=slice("2008-08-01", "2009-08-30"))
            title=str("Aug")  
        elif (qtr==3):
            ds_qtr=ds_tracers.sel(T=slice("2008-11-01", "2009-11-30"))
            title=str("Nov")  
        #
